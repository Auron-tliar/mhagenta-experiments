"""Small public-belief rules for survival and pickaxe progression."""
...
from .beliefs import Direction, cell_key, known_targets, position_from_key
from .contracts import RESOURCE_ITEMS, RESOURCE_TOOLS, ActivityId, ActivitySpec, activity_action_bound
    ...
    *, enable_eat_cow: bool = True,
    ...
    def place(station: str) -> tuple[ActivitySpec | dict[str, Any], dict[str, Any] | None]:
        ...
        for destination in paths:
            if cell_key(destination) not in state["visible_cells"]:
                continue
